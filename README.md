...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydatamail-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15421&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydatamail-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydatamail` can be installed with:

```
conda install pydatamail
```

It is possible to list all of the versions of `pydatamail` available on your platform with:
